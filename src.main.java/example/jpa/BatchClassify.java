...
public class BatchClassify {
	...
	public String getInformation(@QueryParam("") InputStream binStream) throws Exception, IOException {

		System.out
				.println("~~~~~~~~~~~~~ Batch Classify :::::::Classifying Batch Files :"+binStream);
		try {
	        byte[] binByteArray = convertInputStreamToByteArrary(binStream);
	        System.out
			.println("~~~~~~~~~~~~~ Batch Classify :::::::"+binByteArray.toString());
	    } catch (Exception ex) {
	         ex.printStackTrace();
	         return "Fail" ;
	    }
